    ...
    <>
      ...
      <section className="section" style={{ background: "var(--surface)" }}>
        <div className="container">
          {/* Timings Banner */}
          <div className={styles.timingsBanner}>
            <div className={styles.timingsIcon}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            </div>
            <div className={styles.timingsText}>
              <span className={styles.timingsDays}>Monday – Saturday:</span>
              <span className={styles.timingsHours}>10:00 AM – 1:30 PM & 5:00 PM – 8:00 PM</span>
              <span className={styles.timingsSunday}>(Sunday: Closed)</span>
            </div>
          </div>
            ...
            <div className={styles.infoSide}>
              <div className={styles.infoCards}>
                <a href={`tel:${CLINIC.phone}`} className={styles.infoCard} id="contact-call">
                  ...
                  <div>
                    <p className="label-sm">Phone Number</p>
                ...
                <a href={`https://wa.me/${CLINIC.whatsapp}?text=Hi%2C%20I%27d%20like%20to%20book%20an%20appointment.`} target="_blank" rel="noopener noreferrer" className={styles.infoCard} id="contact-whatsapp">
                  ...
                  <div>
                    ...
                    <p className="title-md">Message Now</p>
                  </div>
                </a>

                <EmailObfuscator email={CLINIC.email} className={styles.infoCard}>
                  <div className="icon-badge">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                  </div>
                  <div>
                    <p className="label-sm">Email Address</p>
                    <p className="title-md">{CLINIC.email}</p>
                  </div>
                </EmailObfuscator>
                ...
                <a href={CLINIC.googleMapsUrl} target="_blank" rel="noopener noreferrer" className={styles.infoCard} id="contact-location">
                  ...
                  <div>
                    <p className="label-sm">Location Address</p>
                    <p className="body-md" style={{ fontWeight: 500 }}>{CLINIC.address.full}</p>
                  </div>
                </a>
              </div>
